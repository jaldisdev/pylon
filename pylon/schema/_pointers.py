...
class Tuple:
    """Structural tuple pointer annotation (the upstream engine's inline `tuple<...>` equivalent).
...
class Array:
    """One-dimensional array pointer annotation (the upstream engine's inline `array<...>`
