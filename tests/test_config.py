...
class TestDatabaseConfig:
    ...
    def test_discrete_fields(self):
        db = DatabaseConfig(
            host="localhost", port=5432, name="mydb", user="u", password="p"
        )
...
class TestConfigNormalisation:
    ...
    def test_models_dict_passthrough(self):
        m1 = ModelConfig(
            api_style="openai", api_url="https://api.openai.com", model="m1"
        )
        m2 = ModelConfig(
            api_style="openai", api_url="https://api.mistral.ai", model="m2"
        )
