...
from pylon.schema._registry import functions_snapshot, snapshot
...
def _isolated_registry():
    ...
    from pylon.schema._registry import register_enum, register_scalar, register_type
