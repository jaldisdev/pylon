...
mod tests {
    ...
    fn test_empty_set_cast_to_object_type_clears_optional_link() {
        ...
        // to a plain NULL for the link's FK column, matching real EdgeQL:
    ...
    fn test_postgis_quantizecoordinates_default_arity_variants_compile() {
        // Gel documents this with 3 trailing optional params; Pylon has no
    ...
    fn test_datetime_plus_duration_type_checks() {
        ...
        // Postgres supports `timestamptz + interval` natively and Gel
    ...
    fn test_array_literal_cast_applies_per_element_cast() {
        ...
        // '1' and '2' must actually coerce to int8, matching real EdgeQL
