...
END"#)),
        ...
        // ── crypto:: (pgcrypto) ─────────────────────────────────────────────
        // Mirrors the upstream engine's `ext::pgcrypto` under the `crypto` prefix, straight
        ...
        // Zero-arg form defaults to blowfish ("bf"), matching the upstream engine's own default.
