...
use crate::stdlib::PylonType::{
    BigInt, Bool, Datetime, Decimal, Duration, Float32, Float64, Int16, Int32, Int64, Json, LocalDate, LocalDatetime,
    LocalTime, Str, Uuid,
};
use CastStrategy::{Function as Fn, Implicit, Sql};

fn c(
    source: impl Into<crate::stdlib::PylonType>,
    target: impl Into<crate::stdlib::PylonType>,
